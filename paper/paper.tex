...
\begin{deluxetable}{ccc}[h!]
    \tablecaption{Provisional astrometry for a blob of interest from each epoch. The separation and offset are in relation to Sirius B. The uncertainties were derived from the FWHM of the PSF from each epoch.
